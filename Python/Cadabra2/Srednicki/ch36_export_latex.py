...
cdb_exprs = {
    ...
    "eom_up":    cdb(r"-i \sigmabar^{\mu\dal\alpha} \partial_{\mu}(\psi_{\alpha}) + m \psidag^{\dal}"),
    "eom_down":  cdb(r"-i \sigma^{\mu}_{\alpha\dal} \partial_{\mu}(\psidag^{\dal}) + m \psi_{\alpha}"),
...
\noindent In Cadabra2: $""" + cdb_exprs["eom_up"] + r"""$
...
\noindent In Cadabra2: $""" + cdb_exprs["eom_down"] + r"""$
