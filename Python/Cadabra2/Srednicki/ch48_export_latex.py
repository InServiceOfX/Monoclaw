"""
ch48_export_latex.py
=====================
Generates a LaTeX document for Srednicki Ch. 48 results.
Run inside the cadabra2 Docker container:

    docker run --rm -v $(pwd):/work cadabra2-ubuntu:24.04 \\
        python3 /work/ch48_export_latex.py

Outputs: /work/ch48_massless_spinor_helicity.tex
Then compile on host:
    pdflatex ch48_massless_spinor_helicity.tex
"""
...
outpath = "ch48_massless_spinor_helicity.tex"
