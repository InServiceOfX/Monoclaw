...
\begin{document}
\title{Chapter 48: Massless Particles and Spinor-Helicity}
...
\lambda_{i\alpha}\,\lambda_{j\beta} , \tag{48.16} \\[2mm]
[ij] &\equiv \varepsilon^{\dot\alpha\dot\beta}\,
\tilde\lambda_{i\dot\alpha}\,\tilde\lambda_{j\dot\beta} . \tag{48.17}
\end{align}
\end{mdframed}
