<!-- MERGED SOURCE OF TRUTH (Marker backbone + Nougat equation overlay) -->
<!-- Generated by combine.py. ✓=both agree, ⚠=conflict (verify vs PDF). -->
<!-- NOTE: Nougat dropped eq range(s) 20-32, 36-38; those equations come from Marker only. -->
<!-- NOTE: Nougat repeated eqs {'10': 4, '11': 3, '12': 4, '13': 4, '14': 4, '15': 2, '16': 2, '17': 2} (deduped, ignored here). -->
...
<!-- eq (20) ⚠ MARKER-ONLY (Nougat dropped this) -->
...
<!-- eq (21) ⚠ MARKER-ONLY (Nougat dropped this) -->
...
<!-- eq (22) ⚠ MARKER-ONLY (Nougat dropped this) -->
...
<!-- eq (23) ⚠ MARKER-ONLY (Nougat dropped this) -->
...
<!-- eq (28) ⚠ MARKER-ONLY (Nougat dropped this) -->
...
$$A_{123} = sg_{12}, (29)$$
<!-- eq (29) ⚠ MARKER-ONLY (Nougat dropped this) -->

$$A_{1234} = \frac{1}{2} (sg_{23} sg_{41} + sg_{12} sg_{34}); \tag{30}$$
<!-- eq (30) ⚠ MARKER-ONLY (Nougat dropped this) -->
